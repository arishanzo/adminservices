        ...
        <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 ">
          <div className="flex justify-between items-center h-16">
            ...
            <img
              ...
              src='https://cdn-icons-png.freepik.com/256/9703/9703596.png'
              alt="Profile"
            />

                  <div className=" md:block text-left">
                    <p className="text-sm font-medium text-gray-900">{user?.name || "Guest"}</p>
                    <p className="text-xs text-gray-500">Hello, Admin</p>
                  </div>
                      ...
                      <div className="border-t border-gray-100">
                        <button
                          onClick={async () => {
                           try {
                            await logout();
                            // greenirect ke halaman login setelah logout
                          } catch (error) {
      ...
      <div className="md:hidden fixed bottom-0 left-0 z-50 w-full bg-white border-t border-gray-200">
        <div className="grid h-16 max-w-lg grid-cols-5 mx-auto">
          ...
          <Link to="/pesan" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 group relative">
            ...
            <span className="absolute top-2 right-3 block h-2 w-2 rounded-full bg-green-400"></span>
          </Link>
